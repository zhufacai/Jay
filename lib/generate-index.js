        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .app-container {
                ...
                min-height: calc(100vh - 80px - 100px); /* 填充中间区域 */
                overflow-y: auto;
            }
        ...
        function initMobileMenu() {
            ...
            document.addEventListener('click', (e) => {
                ...
                if (e.target.closest('.mobile-dropdown-item')) {
                    ...
                    } else if (item.hasAttribute('data-album-index')) {
                        const albumIndex = parseInt(item.getAttribute('data-album-index'));
                        if (!isNaN(albumIndex) && albumIndex < musicData.albums.length) {
                            ...
                            renderAlbumSongs(musicData.albums[albumIndex]);
                        }
                    }
