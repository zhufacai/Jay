...
<head>
    ...
    <style>
        ...
        * {
        ...
        .player-container.expanded .player-expanded-view {
            display: flex;
        }
        
        .player-container.expanded .player-collapsed-view {
            display: none;
        }
...
<body>
    ...
    <script>
        ...
        let musicData = {
            ...
            isPlayerCollapsed: true  // 修改为true，使播放器默认为收起状态
        };
